...
/*
public class CoustumAdapter extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_coustum_adapter);
    }
}*/
...
class CustomAdapter extends ArrayAdapter<ContactModel> {
